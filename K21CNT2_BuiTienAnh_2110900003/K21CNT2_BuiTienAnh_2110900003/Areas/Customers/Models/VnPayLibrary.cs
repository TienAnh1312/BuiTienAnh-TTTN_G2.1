...
namespace K21CNT2_BuiTienAnh_2110900003.Areas.Customers.Models
{
    ...
    public class Utils
    {
        ...
        // Constructor để inject IHttpContextAccessor
        ...
        public static string HmacSHA512(string key, string inputData)
        {
            ...
            using (var hmac = new HMACSHA512(keyBytes))
            {
                ...
                {
                    hash.Append(theByte.ToString("x2"));  // Chuyển mỗi byte thành chuỗi hex
                }
            }

            return hash.ToString();  // Trả về chuỗi hex của hash
        }
    }
